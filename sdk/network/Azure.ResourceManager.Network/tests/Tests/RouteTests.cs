...
namespace Azure.ResourceManager.Network.Tests.Tests
{
    public class RouteTests : NetworkServiceClientTestBase
    {
        ...
        public async Task RoutesApiTest()
        {
            ...
            // list route
            AsyncPageable<Route> listRouteResponseAP = getRouteTableResponse.Value.GetRoutes().ListAsync();
            ...
            listRouteResponseAP = getRouteTableResponse.Value.GetRoutes().ListAsync();
