...
namespace Azure.ResourceManager.Network.Tests.Tests
{
    public class VirtualNetworkTests : NetworkServiceClientTestBase
    {
        ...
        public async Task VirtualNetworkApiTest()
        {
            ...
            // Get all Vnets
            AsyncPageable<VirtualNetwork> getAllVnetsAP = virtualNetworkContainer.ListAsync();
            ...
            AsyncPageable<VirtualNetwork> getAllVnetInSubscriptionAP = ArmClient.DefaultSubscription.ListVirtualNetworksAsync();
            ...
            // Get all Vnets
            getAllVnetsAP = virtualNetworkContainer.ListAsync();
        ...
        public async Task VirtualNetworkPeeringTest()
        {
            ...
            // List Peering
            AsyncPageable<VirtualNetworkPeering> listPeerAP = virtualNetworkPeeringContainer.ListAsync();
        ...
        public async Task VirtualNetworkUsageTest()
        {
            ...
            var nicResponse = await WaitForCompletionAsync(putNicResponseOperation);
            // Get Vnet usage again
            // TODO: ADO 6030
            //listUsageResponseAP = virtualNetworkContainer.ListUsageAsync(vnetName);
