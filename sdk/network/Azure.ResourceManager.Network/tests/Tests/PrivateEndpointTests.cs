...
namespace Azure.ResourceManager.Network.Tests.Tests
{
    public class PrivateEndpointTests : NetworkServiceClientTestBase
    {
        ...
        public async Task PrivateEndpointTest()
        {
            ...
            // list
            var privateEndpoints = (await privateEndpointContainer.ListAsync().ToEnumerableAsync());
            ...
            // list all
            privateEndpoints = (await ArmClient.DefaultSubscription.ListPrivateEndpointsAsync().ToEnumerableAsync());
        ...
        public async Task PrivateDnsZoneGroupTest()
        {
            ...
            // list
            var groups = (await privateDnsZoneGroupContainer.ListAsync().ToEnumerableAsync());
            ...
            // list again
            groups = (await privateDnsZoneGroupContainer.ListAsync().ToEnumerableAsync());
        ...
        {
            var types = await ArmClient.DefaultSubscription.ListAvailablePrivateEndpointTypesAsync(TestEnvironment.Location).ToEnumerableAsync();
        ...
        {
            var resourceGroup = (await createResourceGroup()).Value;
            var types = await ArmClient.DefaultSubscription.ListAvailablePrivateEndpointTypesByResourceGroupAsync(TestEnvironment.Location, resourceGroup.Data.Name).ToEnumerableAsync();
            Assert.IsNotEmpty(types);
        }
    }
}
