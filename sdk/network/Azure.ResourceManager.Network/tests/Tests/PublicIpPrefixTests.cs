...
namespace Azure.ResourceManager.Network.Tests.Tests
{
        ...
        : NetworkServiceClientTestBase
    {
        ...
        public async Task PublicIpPrefixApiTest()
        {
            ...
            prefixData = await prefixResponse.Value.UpdateTagsAsync(prefixData.Tags);
            ...
            // list
            var prefixes = await container.ListAsync().ToEnumerableAsync();
            ...
            prefixes = await container.ListAsync().ToEnumerableAsync();
