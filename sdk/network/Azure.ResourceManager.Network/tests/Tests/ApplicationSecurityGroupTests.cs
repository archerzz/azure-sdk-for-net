...
namespace Azure.ResourceManager.Network.Tests.Tests
{
        ...
        : NetworkServiceClientTestBase
    {
        ...
        public async Task ApplicationSecurityGroupApiTest()
        {
            ...
            // list
            var applicationSecurityGroups = await container.ListAsync().ToEnumerableAsync();
            ...
            applicationSecurityGroups = await container.ListAsync().ToEnumerableAsync();
            Assert.IsEmpty(applicationSecurityGroups);

            // list all
            applicationSecurityGroups = await ArmClient.DefaultSubscription.ListApplicationSecurityGroupsAsync().ToEnumerableAsync();
            Assert.IsEmpty(applicationSecurityGroups);
        }
