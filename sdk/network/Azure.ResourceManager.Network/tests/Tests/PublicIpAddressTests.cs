...
namespace Azure.ResourceManager.Network.Tests.Tests
{
    public class PublicIpAddressTests : NetworkServiceClientTestBase
    {
        ...
        public async Task PublicIpAddressApiTest()
        {
            ...
            AsyncPageable<PublicIPAddress> getPublicIpAddressListResponseAP = publicIPAddressContainer.ListAsync();
            ...
            AsyncPageable<PublicIPAddress> getPublicIpAddressListSubscriptionResponseAP = ArmClient.DefaultSubscription.ListPublicIPAddressesAsync();
            ...
            // Get PublicIPAddress
            getPublicIpAddressListResponseAP = publicIPAddressContainer.ListAsync();
