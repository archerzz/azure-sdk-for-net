...
namespace Azure.ResourceManager.Network.Tests.Tests
{
    public class ApplicationGatewayTests : NetworkServiceClientTestBase
    {
        ...
        public async Task ApplicationGatewayApiTest()
        {
            ...
            Response<IReadOnlyList<ApplicationGatewayFirewallRuleSet>> availableWAFRuleSets = await ArmClient.DefaultSubscription.ListApplicationGatewayAvailableWafRuleSetsAsync();
            ...
            Response<ApplicationGatewayAvailableSslOptions> sslOptions = await ArmClient.DefaultSubscription.ListApplicationGatewayAvailableSslOptionAsync();
            ...
            AsyncPageable<ApplicationGatewaySslPredefinedPolicy> policies = ArmClient.DefaultSubscription.ListApplicationGatewayAvailableSslPredefinedPoliciesAsync();
