...
namespace Azure.ResourceManager.Network.Tests.Tests
{
    public class SecurityRuleTests : NetworkServiceClientTestBase
    {
        ...
        public async Task SecurityRuleWithRulesApiTest()
        {
            ...
            AsyncPageable<SecurityRule> getsecurityRulesAP = getNsgResponse.Value.GetSecurityRules().ListAsync();
            ...
            getsecurityRulesAP = getNsgResponse.Value.GetSecurityRules().ListAsync();
