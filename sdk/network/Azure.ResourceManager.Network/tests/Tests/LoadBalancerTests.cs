...
namespace Azure.ResourceManager.Network.Tests.Tests
{
    public class LoadBalancerTests : NetworkServiceClientTestBase
    {
        ...
        public async Task LoadBalancerApiTestAsync()
        {
            ...
            AsyncPageable<LoadBalancer> listLoadBalancerAP = GetResourceGroup(resourceGroupName).GetLoadBalancers().ListAsync();
            ...
            AsyncPageable<LoadBalancer> listLoadBalancerSubscriptionAP = ArmClient.DefaultSubscription.ListLoadBalancersAsync();
            ...
            AsyncPageable<BackendAddressPool> listLoadBalancerBackendAddressPoolsAP = backendAddressPoolContainer.ListAsync();
            ...
            AsyncPageable<FrontendIPConfiguration> listLoadBalancerFrontendIPConfigurationsAP = loadBalancerOperations.ListLoadBalancerFrontendIPConfigurationsAsync();
            ...
            AsyncPageable<LoadBalancingRule> listLoadBalancerLoadBalancingRulesAP = loadBalancerOperations.ListLoadBalancerLoadBalancingRulesAsync();
            ...
            AsyncPageable<NetworkInterfaceData> listLoadBalancerNetworkInterfacesAP = loadBalancerOperations.ListLoadBalancerNetworkInterfacesAsync();
            ...
            AsyncPageable<Probe> listLoadBalancerProbesAP = loadBalancerOperations.ListLoadBalancerProbesAsync();
            ...
            AsyncPageable<InboundNatRule> listInboundNatRulesAP = inboundNatRuleContainer.ListAsync();
            ...
            // Verify Delete
            listLoadBalancerAP = loadBalancerContainer.ListAsync();
        ...
        public async Task LoadBalancerApiTestWithDynamicIp()
        {
            ...
            // Verify List LoadBalancer
            AsyncPageable<LoadBalancer> listLoadBalancerAP = loadBalancerContainer.ListAsync();
            List<LoadBalancer> listLoadBalancer = await listLoadBalancerAP.ToEnumerableAsync();
            Has.One.EqualTo(listLoadBalancer);
            Assert.AreEqual(lbName, listLoadBalancer.First().Data.Name);
            Assert.AreEqual(getLoadBalancer.Value.Data.Etag, listLoadBalancer.First().Data.Etag);
        ...
        public async Task LoadBalancerApiNicAssociationTest()
        {
            ...
            var ipConfigurationsResponse = nic1.ListNetworkInterfaceIPConfigurationsAsync();
            ...
            AsyncPageable<NetworkInterfaceData> listLoadBalancerNetworkInterfacesAP = getLoadBalancer.Value.ListLoadBalancerNetworkInterfacesAsync();
            List<NetworkInterfaceData> listLoadBalancerNetworkInterfaces = await listLoadBalancerNetworkInterfacesAP.ToEnumerableAsync();
