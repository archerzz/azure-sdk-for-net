...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class BgpConnectionOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, BgpConnection>
    {
        ...
        /// <summary> Deletes a VirtualHubBgpConnection. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<VirtualHubBgpConnectionsDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Deletes a VirtualHubBgpConnection. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public VirtualHubBgpConnectionsDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("BgpConnectionOperations.StartDelete");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response<PeerRouteList>> ListLearnedRoutesAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Retrieves a list of routes the virtual hub bgp connection has learned. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<PeerRouteList> ListLearnedRoutes(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("BgpConnectionOperations.ListLearnedRoutes");
            scope.Start();
            try
        ...
        /// <summary> Retrieves a list of routes the virtual hub bgp connection has learned. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<VirtualHubBgpConnectionsListLearnedRoutesOperation> StartListLearnedRoutesAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Retrieves a list of routes the virtual hub bgp connection has learned. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public VirtualHubBgpConnectionsListLearnedRoutesOperation StartListLearnedRoutes(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("BgpConnectionOperations.StartListLearnedRoutes");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response<PeerRouteList>> ListAdvertisedRoutesAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Retrieves a list of routes the virtual hub bgp connection is advertising to the specified peer. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<PeerRouteList> ListAdvertisedRoutes(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("BgpConnectionOperations.ListAdvertisedRoutes");
            scope.Start();
            try
        ...
        /// <summary> Retrieves a list of routes the virtual hub bgp connection is advertising to the specified peer. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<VirtualHubBgpConnectionsListAdvertisedRoutesOperation> StartListAdvertisedRoutesAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Retrieves a list of routes the virtual hub bgp connection is advertising to the specified peer. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public VirtualHubBgpConnectionsListAdvertisedRoutesOperation StartListAdvertisedRoutes(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("BgpConnectionOperations.StartListAdvertisedRoutes");
            scope.Start();
            try
