...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PrivateLinkServiceContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, PrivateLinkService, PrivateLinkServiceData>
    {
        ...
        /// <summary> Filters the list of PrivateLinkService for this resource group represented as generic resources. </summary>
        ...
        public virtual async Task<Response<PrivateEndpointConnection>> UpdatePrivateEndpointConnectionAsync(PrivateEndpointConnection parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("PrivateLinkServiceContainer.UpdatePrivateEndpointConnection");
            scope.Start();
            try
            {
