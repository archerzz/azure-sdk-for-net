...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class BastionHostsCreateShareableLinksOperation : Operation<AsyncPageable<BastionShareableLink>>, IOperationSource<AsyncPageable<BastionShareableLink>>
    {
        private readonly OperationInternals<AsyncPageable<BastionShareableLink>> _operation;
        private readonly Func<string, Task<Response>> _nextPageFunc;

        /// <summary> Initializes a new instance of BastionHostsCreateShareableLinksOperation for mocking. </summary>
        protected BastionHostsCreateShareableLinksOperation()
        {
        }

        internal BastionHostsCreateShareableLinksOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, Func<string, Task<Response>> nextPageFunc)
        {
            _operation = new OperationInternals<AsyncPageable<BastionShareableLink>>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "BastionHostsCreateShareableLinksOperation");
