...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class FirewallPolicyRuleCollectionGroupOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, FirewallPolicyRuleCollectionGroup>
    {
        ...
        /// <summary> Deletes the specified FirewallPolicyRuleCollectionGroup. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<FirewallPolicyRuleCollectionGroupsDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Deletes the specified FirewallPolicyRuleCollectionGroup. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public FirewallPolicyRuleCollectionGroupsDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("FirewallPolicyRuleCollectionGroupOperations.StartDelete");
            scope.Start();
            try
