...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualHubRouteTableV2Operations : ResourceOperationsBase<ResourceGroupResourceIdentifier, VirtualHubRouteTableV2>
    {
        ...
        /// <summary> Deletes a VirtualHubRouteTableV2. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<VirtualHubRouteTableV2SDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Deletes a VirtualHubRouteTableV2. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public VirtualHubRouteTableV2SDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualHubRouteTableV2Operations.StartDelete");
            scope.Start();
            try
