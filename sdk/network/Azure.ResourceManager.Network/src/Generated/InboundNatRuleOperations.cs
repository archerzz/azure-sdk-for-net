...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class InboundNatRuleOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, InboundNatRule>
    {
        ...
        public async Task<Response<InboundNatRule>> GetAsync(string expand, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("InboundNatRuleOperations.Get");
            scope.Start();
            try
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<InboundNatRule> Get(string expand, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("InboundNatRuleOperations.Get");
            scope.Start();
            try
        ...
        /// <summary> Deletes the specified load balancer inbound nat rule. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<InboundNatRulesDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Deletes the specified load balancer inbound nat rule. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public InboundNatRulesDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("InboundNatRuleOperations.StartDelete");
            scope.Start();
            try
