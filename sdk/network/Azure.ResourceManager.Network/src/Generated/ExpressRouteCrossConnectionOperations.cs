...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ExpressRouteCrossConnectionOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, ExpressRouteCrossConnection>
    {
        ...
        /// <summary> Gets the currently advertised ARP table associated with the express route cross connection in a resource group. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<ExpressRouteCrossConnectionsListArpTableOperation> StartListArpTableAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Gets the currently advertised ARP table associated with the express route cross connection in a resource group. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ExpressRouteCrossConnectionsListArpTableOperation StartListArpTable(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteCrossConnectionOperations.StartListArpTable");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response<ExpressRouteCrossConnectionsRoutesTableSummaryListResult>> ListRoutesTableSummaryAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Gets the route table summary associated with the express route cross connection in a resource group. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<ExpressRouteCrossConnectionsRoutesTableSummaryListResult> ListRoutesTableSummary(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteCrossConnectionOperations.ListRoutesTableSummary");
            scope.Start();
            try
        ...
        /// <summary> Gets the route table summary associated with the express route cross connection in a resource group. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<ExpressRouteCrossConnectionsListRoutesTableSummaryOperation> StartListRoutesTableSummaryAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Gets the route table summary associated with the express route cross connection in a resource group. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ExpressRouteCrossConnectionsListRoutesTableSummaryOperation StartListRoutesTableSummary(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteCrossConnectionOperations.StartListRoutesTableSummary");
            scope.Start();
            try
        ...
        /// <summary> Gets the currently advertised routes table associated with the express route cross connection in a resource group. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<ExpressRouteCrossConnectionsListRoutesTableOperation> StartListRoutesTableAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Gets the currently advertised routes table associated with the express route cross connection in a resource group. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ExpressRouteCrossConnectionsListRoutesTableOperation StartListRoutesTable(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteCrossConnectionOperations.StartListRoutesTable");
            scope.Start();
            try
