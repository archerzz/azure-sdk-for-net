...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ApplicationGatewayPrivateEndpointConnectionContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, ApplicationGatewayPrivateEndpointConnection, ApplicationGatewayPrivateEndpointConnectionData>
    {
        ...
        public virtual Response<ApplicationGatewayPrivateEndpointConnection> CreateOrUpdate(string connectionName, ApplicationGatewayPrivateEndpointConnectionData parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ApplicationGatewayPrivateEndpointConnectionContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="connectionName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<Response<ApplicationGatewayPrivateEndpointConnection>> CreateOrUpdateAsync(string connectionName, ApplicationGatewayPrivateEndpointConnectionData parameters, CancellationToken cancellationToken = default)
        {
            if (connectionName == null)
            {
                throw new ArgumentNullException(nameof(connectionName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="connectionName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual ApplicationGatewayPrivateEndpointConnectionsUpdateOperation StartCreateOrUpdate(string connectionName, ApplicationGatewayPrivateEndpointConnectionData parameters, CancellationToken cancellationToken = default)
        {
            if (connectionName == null)
            {
                throw new ArgumentNullException(nameof(connectionName));
            ...
            using var scope = _clientDiagnostics.CreateScope("ApplicationGatewayPrivateEndpointConnectionContainer.StartCreateOrUpdate");
            scope.Start();
            try
            {
                var response = _restClient.Update(Id.ResourceGroupName, Id.Name, connectionName, parameters, cancellationToken);
                return new ApplicationGatewayPrivateEndpointConnectionsUpdateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateUpdateRequest(Id.ResourceGroupName, Id.Name, connectionName, parameters).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="connectionName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<ApplicationGatewayPrivateEndpointConnectionsUpdateOperation> StartCreateOrUpdateAsync(string connectionName, ApplicationGatewayPrivateEndpointConnectionData parameters, CancellationToken cancellationToken = default)
        {
            if (connectionName == null)
            {
                throw new ArgumentNullException(nameof(connectionName));
            ...
            try
            {
                var response = await _restClient.UpdateAsync(Id.ResourceGroupName, Id.Name, connectionName, parameters, cancellationToken).ConfigureAwait(false);
                return new ApplicationGatewayPrivateEndpointConnectionsUpdateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateUpdateRequest(Id.ResourceGroupName, Id.Name, connectionName, parameters).Request, response);
            }
            catch (Exception e)
            {
        ...
        /// <summary> Filters the list of ApplicationGatewayPrivateEndpointConnection for this resource group represented as generic resources. </summary>
