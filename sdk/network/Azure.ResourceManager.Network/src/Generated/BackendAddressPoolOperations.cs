...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class BackendAddressPoolOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, BackendAddressPool>
    {
        ...
        /// <summary> Deletes the specified load balancer backend address pool. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<LoadBalancerBackendAddressPoolsDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Deletes the specified load balancer backend address pool. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public LoadBalancerBackendAddressPoolsDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("BackendAddressPoolOperations.StartDelete");
            scope.Start();
            try
