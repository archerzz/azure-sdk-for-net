...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ExpressRoutePortOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, ExpressRoutePort>
    {
        ...
        /// <summary> Deletes the specified ExpressRoutePort resource. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<ExpressRoutePortsDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Deletes the specified ExpressRoutePort resource. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ExpressRoutePortsDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ExpressRoutePortOperations.StartDelete");
            scope.Start();
            try
