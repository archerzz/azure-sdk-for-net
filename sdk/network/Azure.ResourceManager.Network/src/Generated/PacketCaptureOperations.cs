...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PacketCaptureOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, PacketCapture>
    {
        ...
        /// <summary> Deletes the specified packet capture session. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<PacketCapturesDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Deletes the specified packet capture session. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public PacketCapturesDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PacketCaptureOperations.StartDelete");
            scope.Start();
            try
        ...
        /// <summary> Stops a specified packet capture session. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<PacketCapturesStopOperation> StartStopAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Stops a specified packet capture session. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public PacketCapturesStopOperation StartStop(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PacketCaptureOperations.StartStop");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response<PacketCaptureQueryStatusResult>> GetStatusAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Query the status of a running packet capture session. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<PacketCaptureQueryStatusResult> GetStatus(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PacketCaptureOperations.GetStatus");
            scope.Start();
            try
        ...
        /// <summary> Query the status of a running packet capture session. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<PacketCapturesGetStatusOperation> StartGetStatusAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Query the status of a running packet capture session. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public PacketCapturesGetStatusOperation StartGetStatus(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PacketCaptureOperations.StartGetStatus");
            scope.Start();
            try
