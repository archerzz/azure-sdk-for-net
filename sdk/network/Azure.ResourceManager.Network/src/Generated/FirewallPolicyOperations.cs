...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class FirewallPolicyOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, FirewallPolicy>
    {
        ...
        public async Task<Response<FirewallPolicy>> GetAsync(string expand, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("FirewallPolicyOperations.Get");
            scope.Start();
            try
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<FirewallPolicy> Get(string expand, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("FirewallPolicyOperations.Get");
            scope.Start();
            try
        ...
        /// <summary> Deletes the specified Firewall Policy. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<FirewallPoliciesDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Deletes the specified Firewall Policy. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public FirewallPoliciesDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("FirewallPolicyOperations.StartDelete");
            scope.Start();
            try
