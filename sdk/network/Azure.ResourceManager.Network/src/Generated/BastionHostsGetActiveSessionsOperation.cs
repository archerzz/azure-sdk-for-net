...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class BastionHostsGetActiveSessionsOperation : Operation<AsyncPageable<BastionActiveSession>>, IOperationSource<AsyncPageable<BastionActiveSession>>
    {
        private readonly OperationInternals<AsyncPageable<BastionActiveSession>> _operation;
        private readonly Func<string, Task<Response>> _nextPageFunc;

        /// <summary> Initializes a new instance of BastionHostsGetActiveSessionsOperation for mocking. </summary>
        protected BastionHostsGetActiveSessionsOperation()
        {
        }

        internal BastionHostsGetActiveSessionsOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, Func<string, Task<Response>> nextPageFunc)
        {
            _operation = new OperationInternals<AsyncPageable<BastionActiveSession>>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "BastionHostsGetActiveSessionsOperation");
