...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VpnGatewayOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, VpnGateway>
    {
        ...
        /// <summary> Deletes a virtual wan vpn gateway. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<VpnGatewaysDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Deletes a virtual wan vpn gateway. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public VpnGatewaysDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VpnGatewayOperations.StartDelete");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response<VpnGateway>> UpdateTagsAsync(IDictionary<string, string> tags = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="tags"> Resource tags. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<VpnGateway> UpdateTags(IDictionary<string, string> tags = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VpnGatewayOperations.UpdateTags");
            scope.Start();
            try
        ...
        /// <param name="tags"> Resource tags. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<VpnGatewaysUpdateTagsOperation> StartUpdateTagsAsync(IDictionary<string, string> tags = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="tags"> Resource tags. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public VpnGatewaysUpdateTagsOperation StartUpdateTags(IDictionary<string, string> tags = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VpnGatewayOperations.StartUpdateTags");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response<VpnGatewayData>> ResetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Resets the primary of the vpn gateway in the specified resource group. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<VpnGatewayData> Reset(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VpnGatewayOperations.Reset");
            scope.Start();
            try
        ...
        /// <summary> Resets the primary of the vpn gateway in the specified resource group. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<VpnGatewaysResetOperation> StartResetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Resets the primary of the vpn gateway in the specified resource group. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public VpnGatewaysResetOperation StartReset(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VpnGatewayOperations.StartReset");
            scope.Start();
            try
        ...
        /// <param name="filterData"> Start Packet capture parameters on vpn gateway. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<VpnGatewaysStartPacketCaptureOperation> StartStartPacketCaptureAsync(string filterData = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="filterData"> Start Packet capture parameters on vpn gateway. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public VpnGatewaysStartPacketCaptureOperation StartStartPacketCapture(string filterData = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VpnGatewayOperations.StartStartPacketCapture");
            scope.Start();
            try
        ...
        /// <param name="sasUrl"> SAS url for packet capture on vpn gateway. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<VpnGatewaysStopPacketCaptureOperation> StartStopPacketCaptureAsync(string sasUrl = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="sasUrl"> SAS url for packet capture on vpn gateway. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public VpnGatewaysStopPacketCaptureOperation StartStopPacketCapture(string sasUrl = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VpnGatewayOperations.StartStopPacketCapture");
            scope.Start();
            try
