...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PublicIPAddressOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, PublicIPAddress>
    {
        ...
        public async Task<Response<PublicIPAddress>> GetAsync(string expand, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PublicIPAddressOperations.Get");
            scope.Start();
            try
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<PublicIPAddress> Get(string expand, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PublicIPAddressOperations.Get");
            scope.Start();
            try
        ...
        /// <summary> Deletes the specified public IP address. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<PublicIPAddressesDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Deletes the specified public IP address. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public PublicIPAddressesDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PublicIPAddressOperations.StartDelete");
            scope.Start();
            try
