...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualHubOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, VirtualHub>
    {
        ...
        /// <summary> Deletes a VirtualHub. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<VirtualHubsDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Deletes a VirtualHub. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public VirtualHubsDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualHubOperations.StartDelete");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response> GetEffectiveVirtualHubRoutesAsync(string resourceId = null, string virtualWanResourceType = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="virtualWanResourceType"> The type of the specified resource like RouteTable, ExpressRouteConnection, HubVirtualNetworkConnection, VpnConnection and P2SConnection. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response GetEffectiveVirtualHubRoutes(string resourceId = null, string virtualWanResourceType = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualHubOperations.GetEffectiveVirtualHubRoutes");
            scope.Start();
            try
        ...
        /// <param name="virtualWanResourceType"> The type of the specified resource like RouteTable, ExpressRouteConnection, HubVirtualNetworkConnection, VpnConnection and P2SConnection. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<VirtualHubsGetEffectiveVirtualHubRoutesOperation> StartGetEffectiveVirtualHubRoutesAsync(string resourceId = null, string virtualWanResourceType = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="virtualWanResourceType"> The type of the specified resource like RouteTable, ExpressRouteConnection, HubVirtualNetworkConnection, VpnConnection and P2SConnection. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public VirtualHubsGetEffectiveVirtualHubRoutesOperation StartGetEffectiveVirtualHubRoutes(string resourceId = null, string virtualWanResourceType = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualHubOperations.StartGetEffectiveVirtualHubRoutes");
            scope.Start();
            try
