...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualNetworkGatewayNatRuleOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, VirtualNetworkGatewayNatRule>
    {
        ...
        /// <summary> Deletes a nat rule. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<VirtualNetworkGatewayNatRulesDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Deletes a nat rule. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public VirtualNetworkGatewayNatRulesDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualNetworkGatewayNatRuleOperations.StartDelete");
            scope.Start();
            try
