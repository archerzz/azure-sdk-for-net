...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class CustomIpPrefixOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, CustomIpPrefix>
    {
        ...
        public async Task<Response<CustomIpPrefix>> GetAsync(string expand, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("CustomIpPrefixOperations.Get");
            scope.Start();
            try
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<CustomIpPrefix> Get(string expand, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("CustomIpPrefixOperations.Get");
            scope.Start();
            try
        ...
        /// <summary> Deletes the specified custom IP prefix. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<CustomIPPrefixesDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Deletes the specified custom IP prefix. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public CustomIPPrefixesDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("CustomIpPrefixOperations.StartDelete");
            scope.Start();
            try
