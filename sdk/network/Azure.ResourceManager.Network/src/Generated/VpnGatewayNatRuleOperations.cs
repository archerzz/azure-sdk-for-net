...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VpnGatewayNatRuleOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, VpnGatewayNatRule>
    {
        ...
        /// <summary> Deletes a nat rule. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<NatRulesDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Deletes a nat rule. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public NatRulesDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VpnGatewayNatRuleOperations.StartDelete");
            scope.Start();
            try
