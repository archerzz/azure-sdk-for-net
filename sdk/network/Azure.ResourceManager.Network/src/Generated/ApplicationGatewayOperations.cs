...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ApplicationGatewayOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, ApplicationGateway>
    {
        ...
        /// <summary> Deletes the specified application gateway. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<ApplicationGatewaysDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Deletes the specified application gateway. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ApplicationGatewaysDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ApplicationGatewayOperations.StartDelete");
            scope.Start();
            try
        ...
        /// <summary> Starts the specified application gateway. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<ApplicationGatewaysStartOperation> StartStartAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Starts the specified application gateway. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ApplicationGatewaysStartOperation StartStart(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ApplicationGatewayOperations.StartStart");
            scope.Start();
            try
        ...
        /// <summary> Stops the specified application gateway in a resource group. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<ApplicationGatewaysStopOperation> StartStopAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Stops the specified application gateway in a resource group. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ApplicationGatewaysStopOperation StartStop(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ApplicationGatewayOperations.StartStop");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response<ApplicationGatewayBackendHealth>> BackendHealthAsync(string expand = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="expand"> Expands BackendAddressPool and BackendHttpSettings referenced in backend health. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<ApplicationGatewayBackendHealth> BackendHealth(string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ApplicationGatewayOperations.BackendHealth");
            scope.Start();
            try
        ...
        /// <param name="expand"> Expands BackendAddressPool and BackendHttpSettings referenced in backend health. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<ApplicationGatewaysBackendHealthOperation> StartBackendHealthAsync(string expand = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="expand"> Expands BackendAddressPool and BackendHttpSettings referenced in backend health. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ApplicationGatewaysBackendHealthOperation StartBackendHealth(string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ApplicationGatewayOperations.StartBackendHealth");
            scope.Start();
            try
        ...
        public async Task<Response<ApplicationGatewayBackendHealthOnDemand>> BackendHealthOnDemandAsync(ApplicationGatewayOnDemandProbe probeRequest, string expand = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="probeRequest"/> is null. </exception>
        public Response<ApplicationGatewayBackendHealthOnDemand> BackendHealthOnDemand(ApplicationGatewayOnDemandProbe probeRequest, string expand = null, CancellationToken cancellationToken = default)
        {
            if (probeRequest == null)
            {
                throw new ArgumentNullException(nameof(probeRequest));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="probeRequest"/> is null. </exception>
        public async Task<ApplicationGatewaysBackendHealthOnDemandOperation> StartBackendHealthOnDemandAsync(ApplicationGatewayOnDemandProbe probeRequest, string expand = null, CancellationToken cancellationToken = default)
        {
            if (probeRequest == null)
            {
                throw new ArgumentNullException(nameof(probeRequest));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="probeRequest"/> is null. </exception>
        public ApplicationGatewaysBackendHealthOnDemandOperation StartBackendHealthOnDemand(ApplicationGatewayOnDemandProbe probeRequest, string expand = null, CancellationToken cancellationToken = default)
        {
            if (probeRequest == null)
            {
                throw new ArgumentNullException(nameof(probeRequest));
