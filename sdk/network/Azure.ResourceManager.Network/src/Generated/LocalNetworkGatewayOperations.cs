...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class LocalNetworkGatewayOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, LocalNetworkGateway>
    {
        ...
        /// <summary> Deletes the specified local network gateway. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<LocalNetworkGatewaysDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Deletes the specified local network gateway. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public LocalNetworkGatewaysDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("LocalNetworkGatewayOperations.StartDelete");
            scope.Start();
            try
