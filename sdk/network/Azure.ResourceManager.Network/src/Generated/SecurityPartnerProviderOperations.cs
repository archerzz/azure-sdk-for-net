...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class SecurityPartnerProviderOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, SecurityPartnerProvider>
    {
        ...
        /// <summary> Deletes the specified Security Partner Provider. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<SecurityPartnerProvidersDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Deletes the specified Security Partner Provider. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public SecurityPartnerProvidersDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SecurityPartnerProviderOperations.StartDelete");
            scope.Start();
            try
