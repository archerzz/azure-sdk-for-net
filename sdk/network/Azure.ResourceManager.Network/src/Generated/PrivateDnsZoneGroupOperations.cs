...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PrivateDnsZoneGroupOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, PrivateDnsZoneGroup>
    {
        ...
        /// <summary> Deletes the specified private dns zone group. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<PrivateDnsZoneGroupsDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Deletes the specified private dns zone group. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public PrivateDnsZoneGroupsDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneGroupOperations.StartDelete");
            scope.Start();
            try
